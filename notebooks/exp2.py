...
mlflow.set_tracking_uri("https://dagshub.com/narkeev123/final_mlops1.mlflow")  # Registry URI for model management

# Load the dataset from CSV file and split into training and testing sets
data = pd.read_csv(r"C:\Users\narke\Downloads\archive\water_potability.csv")
